...
<body class="bg-light">
    <div class="vista-usuarios container mt-5">
        ...
        <a href="{{ route('register') }}" class="action-button btn-primary">
...
<a href="{{ route('dashboard') }}" class="action-button btn-alter">
    <div class="svg-wrapper-1">
        <div class="svg-wrapper">
...
<a href="{{ route('json.show') }}" class="action-button btn-success">
    <div class="svg-wrapper-1">
        <div class="svg-wrapper">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
...
>>>>>>> origin/feature/punto-de-venta
    ...
    <a href="{{ route('users.edit', $user->id) }}">
        <button class="action-button btn-alter">
            <div class="svg-wrapper-1">
                <div class="svg-wrapper">
