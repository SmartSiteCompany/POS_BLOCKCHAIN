...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/tabla_users.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('css/dashboard.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('css/json.css')); ?>" />
...
<body>
    ...
    <div class="sidebar">
        <ul>
          ...
          <li><a href="<?php echo e(route('register')); ?>" class="action-button btn-primary text-decoration-none">
         ...
         <li><a href="<?php echo e(route('dashboard')); ?>" class="action-button btn-alter text-decoration-none">
            <div class="svg-wrapper-1">
                <div class="svg-wrapper">
         ...
         <li><a href="<?php echo e(route('json.show')); ?>" class="action-button btn-success text-decoration-none">
            <div class="svg-wrapper-1">
                <div class="svg-wrapper">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
...
<?php /**PATH /home/fany/POS_BLOCKCHAIN/cryptotrade/cryptotrade/resources/views/layouts/app.blade.php ENDPATH**/ ?>